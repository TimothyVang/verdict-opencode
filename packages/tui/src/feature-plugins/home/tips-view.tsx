...
const TIPS: Tip[] = [
  ...
  "Use {highlight}verdict run{/highlight} for non-interactive scripting",
  "Use {highlight}verdict --continue{/highlight} to resume the last session",
  "Use {highlight}verdict run -f file.ts{/highlight} to attach files via CLI",
  "Use {highlight}--format json{/highlight} for machine-readable output in scripts",
  "Run {highlight}verdict serve{/highlight} for headless API access to VERDICT",
  "Use {highlight}verdict run --attach{/highlight} to connect to a running server",
  "Run {highlight}verdict upgrade{/highlight} to update to the latest version",
  "Run {highlight}verdict auth list{/highlight} to see all configured providers",
  "Run {highlight}verdict agent create{/highlight} for guided agent creation",
  "Use {highlight}/evtx{/highlight} to examine Windows Event Logs with FindEvil",
  "Use {highlight}/triage{/highlight} to collect an initial DFIR summary",
  "Use {highlight}/status{/highlight} before a case to confirm MCP tools are connected",
  "Keep evidence paths absolute when working through a remote desktop session",
  ...
  "Run {highlight}verdict debug config{/highlight} to troubleshoot configuration",
  ...
  "Run {highlight}verdict doctor{/highlight} to verify local model and MCP readiness",
  "Use {highlight}/status{/highlight} to confirm VERDICT Local before evidence triage",
